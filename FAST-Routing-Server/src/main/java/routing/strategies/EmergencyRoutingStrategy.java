...
public class EmergencyRoutingStrategy implements IRoutingStrategy {

    private IRoutingEngineClient engineClient;

    public EmergencyRoutingStrategy(IRoutingEngineClient engineClient) {
        this.engineClient = engineClient;
    }

    @Override
    public RouteResponse calculateRoute(RouteRequest request) {
        return engineClient.fetchRoute(request, "ambulance_emergency");
    }
}